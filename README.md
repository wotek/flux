...
- **[Projector](docs/API.md#projections):** Continuous global stream tailing and read-model checkpointing.
- **[Orchestrator / Saga](docs/API.md#sagas--process-managers):** Coordinates multi-step workflows with durable outbox delivery.
