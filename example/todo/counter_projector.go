...
func NewCounterProjector(
	...
	projection.RegisterHandler(projector, func(ctx projection.Context, _ TaskAdded) error {
	...
	projection.RegisterHandler(projector, func(ctx projection.Context, _ TaskRemoved) error {
