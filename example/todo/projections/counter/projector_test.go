...
func TestCounterProjector_UpdatesMetrics(t *testing.T) {
	...
	projID := flux.MustParseIdentifier("urn:todo:prod:projections:1:counter:unit")
	...
	stream := flux.Stream{Identifier: flux.MustParseIdentifier("urn:todo:prod:lists:1:list:unit-test")}
	...
	envelopes := []flux.Envelope{
		{Identifier: flux.MustParseIdentifier("urn:todo:prod:events:1:event:1"), Stream: stream, Event: events.TaskAdded{Task: "A"}},
		{Identifier: flux.MustParseIdentifier("urn:todo:prod:events:1:event:2"), Stream: stream, Event: events.TaskAdded{Task: "B"}},
		{Identifier: flux.MustParseIdentifier("urn:todo:prod:events:1:event:3"), Stream: stream, Event: events.TaskAdded{Task: "C"}},
		{Identifier: flux.MustParseIdentifier("urn:todo:prod:events:1:event:4"), Stream: stream, Event: events.TaskRemoved{Task: "A"}},
		{Identifier: flux.MustParseIdentifier("urn:todo:prod:events:1:event:5"), Stream: stream, Event: events.TasksDone{Tasks: []string{"B"}}},
	}
